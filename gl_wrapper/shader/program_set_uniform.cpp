...
namespace gl_wrapper
{
    ...
    void Program::set_uniform(GLint location, const glm::mat2 &value, GLboolean transpose) { glProgramUniformMatrix2fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat2x3 &value, GLboolean transpose) { glProgramUniformMatrix2x3fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat2x4 &value, GLboolean transpose) { glProgramUniformMatrix2x4fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat3 &value, GLboolean transpose) { glProgramUniformMatrix3fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat3x2 &value, GLboolean transpose) { glProgramUniformMatrix3x2fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat3x4 &value, GLboolean transpose) { glProgramUniformMatrix3x4fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat4 &value, GLboolean transpose) { glProgramUniformMatrix4fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat4x2 &value, GLboolean transpose) { glProgramUniformMatrix4x2fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
    void Program::set_uniform(GLint location, const glm::mat4x3 &value, GLboolean transpose) { glProgramUniformMatrix4x3fv(m_id, location, 1, transpose, glm::value_ptr(value)); }
